...
model_exp_2.gp_model1.x_measurements[0] = np.concatenate([data_method_2_train_m1[0], data_method_2_train_m1[9]], axis=0, dtype='float32')
model_exp_2.gp_model1.x_measurements[1] = np.concatenate([data_method_2_train_m1[1], data_method_2_train_m1[10]], axis=0, dtype='float32')
model_exp_2.gp_model1.x_measurements[2] = np.concatenate([data_method_2_train_m1[2], data_method_2_train_m1[11]], axis=0, dtype='float32')
model_exp_2.gp_model1.x_measurements[3] = np.concatenate([data_method_2_train_m1[3], data_method_2_train_m1[12]], axis=0, dtype='float32')
model_exp_2.gp_model1.x_measurements[4] = np.concatenate([data_method_2_train_m1[4], data_method_2_train_m1[13]], axis=0, dtype='float32')
model_exp_2.gp_model1.x_measurements[5] = np.concatenate([data_method_2_train_m1[5], data_method_2_train_m1[14]], axis=0, dtype='float32')

model_exp_2.gp_model1.y_measurements[0] = np.concatenate([data_method_2_train_m1[6], data_method_2_train_m1[15]], axis=0, dtype='float32')
model_exp_2.gp_model1.y_measurements[1] = np.concatenate([data_method_2_train_m1[7], data_method_2_train_m1[16]], axis=0, dtype='float32')
model_exp_2.gp_model1.y_measurements[2] = np.concatenate([data_method_2_train_m1[8], data_method_2_train_m1[17]], axis=0, dtype='float32')
